...
async function connectToOrg1CA() {
	...
	const caOrg1Client = buildCAClient(FabricCAServices, ccpOrg1, 'ca.org1.data-collector.com');
...
async function connectToOrg2CA() {
	...
	const caOrg2Client = buildCAClient(FabricCAServices, ccpOrg2, 'ca.org2.data-collector.com');
...
async function connectToOrg3CA() {
	...
	const caOrg3Client = buildCAClient(FabricCAServices, ccpOrg3, 'ca.org3.data-collector.com');
