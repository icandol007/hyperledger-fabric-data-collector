...
async function main() {
    try {
        // 네트워크 구성 파일
        const ccpPath = path.resolve(__dirname, '..', 'infra', 'crypto-config', 'peerOrganizations', 'org1.data-collector.com', 'connection-org1.json');
        ...
        const ca = new FabricCAServices(caInfo.url, { trustedRoots: caTLSCAerts, verify: false }, caInfo.caName); // CA 클라이언트 인스턴스 생성
